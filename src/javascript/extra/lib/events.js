...
logger = logger.module("events");
var Event = org.bukkit.event;
...
function on(eventName, handler, priority){
	...
	var registeredListener = new org.bukkit.plugin.RegisteredListener(_plugin, ee, priority, _plugin, false);
